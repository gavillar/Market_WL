package com.example.market_wl.layout.address.presenter;
...
public class AdressFragment extends Fragment {
    ...
    private AdressViewModel mViewModel;
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        mViewModel = new ViewModelProvider(this).get(AdressViewModel.class);
